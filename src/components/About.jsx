        ...
        <>
            <Container fluid id="aboutsec">
                ...
                <Row>
                    ...
                    <Col md={{span: 6, order: 1}} className="px-5 align-items-center hotel-text">
                        <div>
